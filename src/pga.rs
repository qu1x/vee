...
impl<const M: i8> Multivector<Pga<M, 4>> {
    ...
    ///     "+(+[+2ac-2bv-2df]~Z+[-2Xv-2Yc+2Zb-2dÐ]~w+[+2bf-2ce-2dv]~Ð",
    ///       "+[+1aa-1bb-1cc-1dd+1ee+1ff+1vv]~X+[+2ab+2cv-2de]~Y)e0324\n",
    ///     "+(+[+2Xc-2Yv-2Za-2eÐ]~w+[-2af+2cd-2ev]~Ð+[+2ab-2cv-2de]~X",
    ///       "+[-1aa+1bb-1cc+1dd-1ee+1ff+1vv]~Y+[+2av+2bc-2ef]~Z)e0134\n",
    ///     "+(+[+2ae-2bd-2fv]~Ð+[+2ac+2bv-2df]~X+[-2av+2bc-2ef]~Y",
    ///       "+[-1aa-1bb+1cc+1dd+1ee-1ff+1vv]~Z+[-2Xb+2Ya-2Zv-2fÐ]~w)e0214\n",
    ///     "+(+[+2bf-2ce+2dv]~X+[-2af+2cd+2ev]~Y+[+2ae-2bd+2fv]~Z",
    ///       "+[-2Xd-2Ye-2Zf+2vÐ]~w+[+1aa+1bb+1cc-1dd-1ee-1ff+1vv]~Ð)e0123\n",
    /// ));
    ///
    ...
    ///     "+(+[+1aa+1bb+1cc+1dd+1ee+1ff+1vv]~W+[+2Xv-2Yc+2Zb-2dÐ]~x",
    ///       "+[+2Xc+2Yv-2Za-2eÐ]~y+[-2Xb+2Ya+2Zv-2fÐ]~z+[-2Xd-2Ye-2Zf-2vÐ]~ð)e0\n",
    ///     "+(+[+2ab+2cv-2de]~y+[+2ac-2bv-2df]~z+[+2bf-2ce-2dv]~ð",
    ///       "+[+1aa-1bb-1cc-1dd+1ee+1ff+1vv]~x)e1\n",
    ///     "+(+[+2av+2bc-2ef]~z+[-2af+2cd-2ev]~ð+[+2ab-2cv-2de]~x",
    ///       "+[-1aa+1bb-1cc+1dd-1ee+1ff+1vv]~y)e2\n",
    ///     "+(+[+2ae-2bd-2fv]~ð+[+2ac+2bv-2df]~x+[-2av+2bc-2ef]~y",
    ///       "+[-1aa-1bb+1cc+1dd+1ee-1ff+1vv]~z)e3\n",
    ///     "+(+[+2bf-2ce+2dv]~x+[-2af+2cd+2ev]~y+[+2ae-2bd+2fv]~z",
    ///       "+[+1aa+1bb+1cc-1dd-1ee-1ff+1vv]~ð)e4\n",
    ///     "+(+[+2ad+2be+2cf]~W+[-2Yf+2Ze-2aÐ]~x+[+2Xf-2Zd-2bÐ]~y",
    ///       "+[-2Xe+2Yd-2cÐ]~z+[-2Xa-2Yb-2Zc]~ð)I\n", // Vanishes with point condition.
    /// ));
    /// ```
    #[must_use]
    #[inline]
    ...
    ///     "+1LvRv\n",
    ///     "+(-1LbRZ+1LcRY+1LdRÐ+1LvRX)e01\n",
    ///     "+(+1LaRZ-1LcRX+1LeRÐ+1LvRY)e02\n",
    ///     "+(-1LaRY+1LbRX+1LfRÐ+1LvRZ)e03\n",
    ///     "+(-1LdRX-1LeRY-1LfRZ+1LvRÐ)e40\n",
    ///     "+1LaRve23\n",
    ///     "+1LbRve31\n",
    ///     "+1LcRve12\n",
    ///     "+1LdRve41\n",
    ///     "+1LeRve42\n",
    ///     "+1LfRve43\n",
    ///     "+(+1LaRÐ-1LeRZ+1LfRY)e0324\n",
    ///     "+(+1LbRÐ+1LdRZ-1LfRX)e0134\n",
    ///     "+(+1LcRÐ-1LdRY+1LeRX)e0214\n",
    ...
    /// assert_eq!(format!("{single_motor:#}"), concat!(
    ///     "-1LxRx-1LyRy-1LzRz-1LðRð\n",
    ///     "+(-1LBRz+1LCRy+1LDRð-1LyRC+1LzRB-1LðRD)e01\n",
    ///     "+(+1LARz-1LCRx+1LERð+1LxRC-1LzRA-1LðRE)e02\n",
    ///     "+(-1LARy+1LBRx+1LFRð-1LxRB+1LyRA-1LðRF)e03\n",
    ...
    ///     "+(-1LyRð+1LðRy)e42\n",
    ///     "+(-1LzRð+1LðRz)e43\n",
    ///     "+(+1LARð-1LERz+1LFRy+1LyRF-1LzRE+1LðRA)e0324\n",
    ///     "+(+1LBRð+1LDRz-1LFRx-1LxRF+1LzRD+1LðRB)e0134\n",
    ///     "+(+1LCRð-1LDRy+1LERx+1LxRE-1LyRD+1LðRC)e0214\n",
    ...
    ///     "+1LfRve43\n",
    ///     "+1LwRve1234\n",
    ///     "+(+1LaRÐ-1LeRZ+1LfRY+1LwRX)e0324\n",
    ///     "+(+1LbRÐ+1LdRZ-1LfRX+1LwRY)e0134\n",
    ///     "+(+1LcRÐ-1LdRY+1LeRX+1LwRZ)e0214\n",
    ///     "+(+1LaRX+1LbRY+1LcRZ-1LwRÐ)e0123\n",
    /// ));
    ///
    ...
    /// assert_eq!(format!("{double_motor:#}"), concat!(
    ///     "-1LaRa-1LbRb-1LcRc-1LdRd-1LeRe-1LfRf\n",
    ///     "+(-1LYRc+1LZRb-1LbRZ+1LcRY+1LdRÐ-1LÐRd)e01\n",
    ///     "+(+1LXRc-1LZRa+1LaRZ-1LcRX+1LeRÐ-1LÐRe)e02\n",
    ///     "+(-1LXRb+1LYRa-1LaRY+1LbRX+1LfRÐ-1LÐRf)e03\n",
    ...
    ///     "+(-1LaRe+1LbRd-1LdRb+1LeRa)e43\n",
    ///     "+(-1LaRd-1LbRe-1LcRf-1LdRa-1LeRb-1LfRc)e1234\n",
    ///     "+(+1LYRf-1LZRe+1LaRÐ-1LeRZ+1LfRY+1LÐRa)e0324\n",
    ///     "+(-1LXRf+1LZRd+1LbRÐ+1LdRZ-1LfRX+1LÐRb)e0134\n",
    ///     "+(+1LXRe-1LYRd+1LcRÐ-1LdRY+1LeRX+1LÐRc)e0214\n",
    ...
    /// assert_eq!(rotoreflector.basis_blades(), Vee::rotoreflector().basis_blades());
    /// assert_eq!(format!("{rotoreflector:#}"), concat!(
    ///     "+(+1LxRv-1LyRc+1LzRb+1LðRd)e1\n",
    ///     "+(+1LxRc+1LyRv-1LzRa+1LðRe)e2\n",
    ///     "+(-1LxRb+1LyRa+1LzRv+1LðRf)e3\n",
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv)e4\n",
    ///     "+(-1LyRf+1LzRe+1LðRa)e234\n",
    ///     "+(+1LxRf-1LzRd+1LðRb)e314\n",
    ///     "+(-1LxRe+1LyRd+1LðRc)e124\n",
    ...
    /// assert_eq!(format!("{point:#}"), concat!(
    ///     "+[+2xx+2yy+2zz-2ðð]~w\n", // Vanishes with weight condition.
    ///     "+(+[-2xx-2yy-2zz-2ðð]~w)e1234\n",
    ///     "+(+[+4xð]~Ð+[-4zð]~Y+[+4yð]~Z)e0324\n",
    ///     "+(+[+4zð]~X+[-4xð]~Z+[+4yð]~Ð)e0134\n",
    ///     "+(+[+4xð]~Y+[+4zð]~Ð+[-4yð]~X)e0214\n",
    ///     "+(+[+4zð]~Z+[+4xð]~X+[+4yð]~Y)e0123\n",
    /// ));
    /// ```
    #[must_use]
    #[inline]
    ...
    /// assert_eq!(flector.basis_blades(), Vee::flector().basis_blades());
    /// assert_eq!(format!("{flector:#}"), concat!(
    ///     "+(+1LWRv-1LxRX-1LyRY-1LzRZ+1LðRÐ)e0\n",
    ///     "+(+1LxRv-1LyRc+1LzRb+1LðRd)e1\n",
    ///     "+(+1LxRc+1LyRv-1LzRa+1LðRe)e2\n",
    ///     "+(-1LxRb+1LyRa+1LzRv+1LðRf)e3\n",
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv)e4\n",
    ...
    ///     "+(-1LxRe+1LyRd+1LðRc)e124\n",
    ///     "+(+1LxRa+1LyRb+1LzRc)e123\n",
    ///     "+(-1LWRd+1LxRÐ-1LyRZ+1LzRY+1LðRX)e014\n",
    ///     "+(-1LWRe+1LxRZ+1LyRÐ-1LzRX+1LðRY)e024\n",
    ///     "+(-1LWRf-1LxRY+1LyRX+1LzRÐ+1LðRZ)e034\n",
    ///     "+(-1LWRa+1LxRÐ+1LyRZ-1LzRY-1LðRX)e032\n",
    ///     "+(-1LWRb-1LxRZ+1LyRÐ+1LzRX-1LðRY)e013\n",
    ///     "+(-1LWRc+1LxRY-1LyRX+1LzRÐ-1LðRZ)e021\n",
    ///     "+(+1LxRX+1LyRY+1LzRZ+1LðRÐ)I\n",
    /// ));
    /// ```
    #[must_use]
    #[inline]
...
impl<const M: i8> Multivector<Pga<M, 5>> {
    ...
    /// The multivector of normal $`h_0 \equiv x\e_1 + y\e_2 + z\e_3 + ð\e_4 + þ\e_5`$.
    #[must_use]
    #[inline]
    pub fn normal() -> Self {
    ...
    /// assert_eq!(format!("{single_motor:#}"), concat!(
    ///     "+1LvRv\n",
    ///     "+(-1LbRZ+1LcRY+1LdRÐ+1LgRÞ+1LvRX)e01\n",
    ///     "+(+1LaRZ-1LcRX+1LeRÐ+1LhRÞ+1LvRY)e02\n",
    ///     "+(-1LaRY+1LbRX+1LfRÐ+1LiRÞ+1LvRZ)e03\n",
    ///     "+(-1LdRX-1LeRY-1LfRZ-1LjRÞ+1LvRÐ)e40\n",
    ///     "+(-1LgRX-1LhRY-1LiRZ+1LjRÐ+1LvRÞ)e05\n",
    ///     "+1LaRve23\n",
    ///     "+1LbRve31\n",
    ///     "+1LcRve12\n",
    ///     "+1LdRve41\n",
    ...
    ///     "+1LiRve35\n",
    ///     "+1LjRve45\n",
    ///     "+(-1LdRÞ+1LgRÐ+1LjRX)e0145\n",
    ///     "+(-1LeRÞ+1LhRÐ+1LjRY)e0245\n",
    ///     "+(-1LfRÞ+1LiRÐ+1LjRZ)e0345\n",
    ///     "+(-1LaRÞ+1LhRZ-1LiRY)e0325\n",
    ///     "+(-1LbRÞ-1LgRZ+1LiRX)e0135\n",
    ///     "+(-1LcRÞ+1LgRY-1LhRX)e0215\n",
    ///     "+(+1LaRÐ-1LeRZ+1LfRY)e0324\n",
    ///     "+(+1LbRÐ+1LdRZ-1LfRX)e0134\n",
    ///     "+(+1LcRÐ-1LdRY+1LeRX)e0214\n",
    ///     "+(+1LaRX+1LbRY+1LcRZ)e0123\n",
    ...
    /// assert_eq!(format!("{single_motor:#}"), concat!(
    ///     "+1LxRx+1LyRy+1LzRz+1LðRð+1LþRþ\n",
    ///     "+(+1LBRz-1LCRy-1LDRð-1LGRþ+1LyRC-1LzRB+1LðRD+1LþRG)e01\n",
    ///     "+(-1LARz+1LCRx-1LERð-1LHRþ-1LxRC+1LzRA+1LðRE+1LþRH)e02\n",
    ///     "+(+1LARy-1LBRx-1LFRð-1LIRþ+1LxRB-1LyRA+1LðRF+1LþRI)e03\n",
    ///     "+(+1LDRx+1LERy+1LFRz+1LJRþ-1LxRD-1LyRE-1LzRF-1LþRJ)e40\n",
    ///     "+(+1LGRx+1LHRy+1LIRz-1LJRð-1LxRG-1LyRH-1LzRI+1LðRJ)e05\n",
    ///     "+(+1LyRz-1LzRy)e23\n",
    ///     "+(-1LxRz+1LzRx)e31\n",
    ///     "+(+1LxRy-1LyRx)e12\n",
    ///     "+(+1LxRð-1LðRx)e41\n",
    ...
    ///     "+(+1LzRþ-1LþRz)e35\n",
    ///     "+(-1LðRþ+1LþRð)e45\n",
    ///     "+(+1LDRþ-1LGRð-1LJRx-1LxRJ-1LðRG+1LþRD)e0145\n",
    ///     "+(+1LERþ-1LHRð-1LJRy-1LyRJ-1LðRH+1LþRE)e0245\n",
    ///     "+(+1LFRþ-1LIRð-1LJRz-1LzRJ-1LðRI+1LþRF)e0345\n",
    ///     "+(+1LARþ-1LHRz+1LIRy+1LyRI-1LzRH+1LþRA)e0325\n",
    ///     "+(+1LBRþ+1LGRz-1LIRx-1LxRI+1LzRG+1LþRB)e0135\n",
    ///     "+(+1LCRþ-1LGRy+1LHRx+1LxRH-1LyRG+1LþRC)e0215\n",
    ///     "+(-1LARð+1LERz-1LFRy-1LyRF+1LzRE-1LðRA)e0324\n",
    ///     "+(-1LBRð-1LDRz+1LFRx+1LxRF-1LzRD-1LðRB)e0134\n",
    ///     "+(-1LCRð+1LDRy-1LERx-1LxRE+1LyRD-1LðRC)e0214\n",
    ///     "+(-1LARx-1LBRy-1LCRz-1LxRA-1LyRB-1LzRC)e0123\n",
    ...
    ///     "-1LaRa-1LbRb-1LcRc-1LdRd-1LeRe-1LfRf-1LgRg-1LhRh-1LiRi-1LjRj\n",
    ///     "+(-1LYRc+1LZRb-1LbRZ+1LcRY+1LdRÐ+1LgRÞ-1LÐRd-1LÞRg)e01\n",
    ///     "+(+1LXRc-1LZRa+1LaRZ-1LcRX+1LeRÐ+1LhRÞ-1LÐRe-1LÞRh)e02\n",
    ///     "+(-1LXRb+1LYRa-1LaRY+1LbRX+1LfRÐ+1LiRÞ-1LÐRf-1LÞRi)e03\n",
    ///     "+(+1LXRd+1LYRe+1LZRf-1LdRX-1LeRY-1LfRZ-1LjRÞ+1LÞRj)e40\n",
    ///     "+(+1LXRg+1LYRh+1LZRi-1LgRX-1LhRY-1LiRZ+1LjRÐ-1LÐRj)e05\n",
    ///     "+(-1LbRc+1LcRb-1LeRf+1LfRe-1LhRi+1LiRh)e23\n",
    ///     "+(+1LaRc-1LcRa+1LdRf-1LfRd+1LgRi-1LiRg)e31\n",
    ///     "+(-1LaRb+1LbRa-1LdRe+1LeRd-1LgRh+1LhRg)e12\n",
    ///     "+(-1LbRf+1LcRe-1LeRc+1LfRb+1LgRj-1LjRg)e41\n",
    ...
    ///     "+(+1LaRg+1LbRh+1LcRi+1LgRa+1LhRb+1LiRc)e1235\n",
    ///     "+(-1LaRd-1LbRe-1LcRf-1LdRa-1LeRb-1LfRc)e1234\n",
    ///     "+(+1LXRj-1LdRÞ+1LgRÐ+1LjRX+1LÐRg-1LÞRd)e0145\n",
    ///     "+(+1LYRj-1LeRÞ+1LhRÐ+1LjRY+1LÐRh-1LÞRe)e0245\n",
    ///     "+(+1LZRj-1LfRÞ+1LiRÐ+1LjRZ+1LÐRi-1LÞRf)e0345\n",
    ///     "+(-1LYRi+1LZRh-1LaRÞ+1LhRZ-1LiRY-1LÞRa)e0325\n",
    ///     "+(+1LXRi-1LZRg-1LbRÞ-1LgRZ+1LiRX-1LÞRb)e0135\n",
    ///     "+(-1LXRh+1LYRg-1LcRÞ+1LgRY-1LhRX-1LÞRc)e0215\n",
    ///     "+(+1LYRf-1LZRe+1LaRÐ-1LeRZ+1LfRY+1LÐRa)e0324\n",
    ///     "+(-1LXRf+1LZRd+1LbRÐ+1LdRZ-1LfRX+1LÐRb)e0134\n",
    ///     "+(+1LXRe-1LYRd+1LcRÐ-1LdRY+1LeRX+1LÐRc)e0214\n",
    ///     "+(+1LXRa+1LYRb+1LZRc+1LaRX+1LbRY+1LcRZ)e0123\n",
    ...
    ///     "+1LðRve1235\n",
    ///     "+1LþRve1234\n",
    ///     "+(-1LdRÞ+1LgRÐ+1LjRX-1LyRZ+1LzRY)e0145\n",
    ///     "+(-1LeRÞ+1LhRÐ+1LjRY+1LxRZ-1LzRX)e0245\n",
    ///     "+(-1LfRÞ+1LiRÐ+1LjRZ-1LxRY+1LyRX)e0345\n",
    ///     "+(-1LaRÞ+1LhRZ-1LiRY-1LxRÐ+1LðRX)e0325\n",
    ///     "+(-1LbRÞ-1LgRZ+1LiRX-1LyRÐ+1LðRY)e0135\n",
    ///     "+(-1LcRÞ+1LgRY-1LhRX-1LzRÐ+1LðRZ)e0215\n",
    ///     "+(+1LaRÐ-1LeRZ+1LfRY-1LxRÞ+1LþRX)e0324\n",
    ///     "+(+1LbRÐ+1LdRZ-1LfRX-1LyRÞ+1LþRY)e0134\n",
    ///     "+(+1LcRÐ-1LdRY+1LeRX-1LzRÞ+1LþRZ)e0214\n",
    ...
    ///     "+(+1LxRv-1LyRc+1LzRb+1LðRd-1LþRg)e1\n",
    ///     "+(+1LxRc+1LyRv-1LzRa+1LðRe-1LþRh)e2\n",
    ///     "+(-1LxRb+1LyRa+1LzRv+1LðRf-1LþRi)e3\n",
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv-1LþRj)e4\n",
    ///     "+(+1LxRg+1LyRh+1LzRi+1LðRj+1LþRv)e5\n",
    ///     "+(-1LyRf+1LzRe+1LðRa)e234\n",
    ///     "+(-1LxRf+1LzRd-1LðRb)e134\n",
    ///     "+(-1LxRe+1LyRd+1LðRc)e124\n",
    ///     "+(+1LxRa+1LyRb+1LzRc)e123\n",
    ///     "+(-1LyRi+1LzRh-1LþRa)e253\n",
    ///     "+(-1LxRi+1LzRg+1LþRb)e315\n",
    ///     "+(-1LxRh+1LyRg-1LþRc)e152\n",
    ///     "+(+1LxRj-1LðRg-1LþRd)e145\n",
    ///     "+(+1LyRj-1LðRh-1LþRe)e245\n",
    ///     "+(+1LzRj-1LðRi-1LþRf)e345\n",
    /// ));
    /// ```
    #[must_use]
    #[inline]
    ...
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv-1LþRj)e4\n",
    ///     "+(+1LxRg+1LyRh+1LzRi+1LðRj+1LþRv)e5\n",
    ///     "+(+1LxRþ-1LyRf+1LzRe+1LðRa-1LþRx)e234\n",
    ///     "+(-1LxRf-1LyRþ+1LzRd-1LðRb+1LþRy)e134\n",
    ///     "+(-1LxRe+1LyRd+1LzRþ+1LðRc-1LþRz)e124\n",
    ///     "+(+1LxRa+1LyRb+1LzRc-1LðRþ-1LþRð)e123\n",
    ///     "+(-1LxRð-1LyRi+1LzRh-1LðRx-1LþRa)e253\n",
    ///     "+(-1LxRi+1LyRð+1LzRg+1LðRy+1LþRb)e315\n",
    ///     "+(-1LxRh+1LyRg-1LzRð-1LðRz-1LþRc)e152\n",
    ///     "+(+1LxRj-1LyRz+1LzRy-1LðRg-1LþRd)e145\n",
    ///     "+(+1LxRz+1LyRj-1LzRx-1LðRh-1LþRe)e245\n",
    ///     "+(-1LxRy+1LyRx+1LzRj-1LðRi-1LþRf)e345\n",
    ...
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv-1LþRj)e4\n",
    ///     "+(+1LxRg+1LyRh+1LzRi+1LðRj+1LþRv)e5\n",
    ///     "+(+1LWRg-1LxRÞ+1LþRX)e015\n",
    ///     "+(-1LWRh+1LyRÞ-1LþRY)e052\n",
    ///     "+(+1LWRi-1LzRÞ+1LþRZ)e035\n",
    ///     "+(-1LWRj+1LðRÞ+1LþRÐ)e054\n",
    ///     "+(-1LWRd+1LxRÐ+1LðRX)e014\n",
    ///     "+(+1LWRe-1LyRÐ-1LðRY)e042\n",
    ///     "+(-1LWRf+1LzRÐ+1LðRZ)e034\n",
    ...
    ///     "+(-1LxRd-1LyRe-1LzRf+1LðRv-1LþRj)e4\n",
    ///     "+(+1LxRg+1LyRh+1LzRi+1LðRj+1LþRv)e5\n",
    ///     "+(+1LWRg-1LxRÞ-1LyRF+1LzRE+1LðRA+1LþRX)e015\n",
    ///     "+(-1LWRh-1LxRF+1LyRÞ+1LzRD-1LðRB-1LþRY)e052\n",
    ///     "+(+1LWRi-1LxRE+1LyRD-1LzRÞ+1LðRC+1LþRZ)e035\n",
    ///     "+(-1LWRj+1LxRA+1LyRB+1LzRC+1LðRÞ+1LþRÐ)e054\n",
    ///     "+(-1LWRd+1LxRÐ-1LyRI+1LzRH+1LðRX-1LþRA)e014\n",
    ///     "+(+1LWRe-1LxRI-1LyRÐ+1LzRG-1LðRY+1LþRB)e042\n",
    ///     "+(-1LWRf-1LxRH+1LyRG+1LzRÐ+1LðRZ-1LþRC)e034\n",
    ///     "+(-1LWRa+1LxRJ+1LyRZ-1LzRY-1LðRG-1LþRD)e032\n",
    ///     "+(-1LWRb-1LxRZ+1LyRJ+1LzRX-1LðRH-1LþRE)e013\n",
    ///     "+(-1LWRc+1LxRY-1LyRX+1LzRJ-1LðRI-1LþRF)e021\n",
    ///     "+(-1LyRf+1LzRe+1LðRa)e234\n",
    ///     "+(-1LxRf+1LzRd-1LðRb)e134\n",
    ///     "+(-1LxRe+1LyRd+1LðRc)e124\n",
    ///     "+(+1LxRa+1LyRb+1LzRc)e123\n",
    ...
    ///     "+(+1LyRj-1LðRh-1LþRe)e245\n",
    ///     "+(+1LzRj-1LðRi-1LþRf)e345\n",
    ///     "+(+1LyRC-1LzRB-1LðRD+1LþRG)e03245\n",
    ///     "+(-1LxRC+1LzRA-1LðRE+1LþRH)e01345\n",
    ///     "+(+1LxRB-1LyRA-1LðRF+1LþRI)e02145\n",
    ///     "+(+1LxRD+1LyRE+1LzRF+1LþRJ)e01235\n",
    ///     "+(-1LxRG-1LyRH-1LzRI-1LðRJ)e01243\n",
    /// ));
    /// ```
    #[must_use]
    #[inline]
    ...
    ///     "+(-1LxRy+1LyRx+1LzRj-1LðRi-1LþRf)e345\n",
    ///     "+(+1LxRx+1LyRy+1LzRz-1LðRð+1LþRþ)e12345\n",
    ///     "+(-1LWRx+1LyRC-1LzRB-1LðRD+1LþRG)e03245\n",
    ///     "+(-1LWRy-1LxRC+1LzRA-1LðRE+1LþRH)e01345\n",
    ///     "+(-1LWRz+1LxRB-1LyRA-1LðRF+1LþRI)e02145\n",
    ///     "+(+1LWRð+1LxRD+1LyRE+1LzRF+1LþRJ)e01235\n",
    ///     "+(-1LWRþ-1LxRG-1LyRH-1LzRI-1LðRJ)e01243\n",
    /// ));
    ///
    ...
    ///     "+(-1LxRy+1LyRx+1LzRj-1LðRi-1LþRf)e345\n",
    ///     "+(+1LxRx+1LyRy+1LzRz-1LðRð+1LþRþ)e12345\n",
    ///     "+(-1LWRx+1LxRV+1LyRC-1LzRB-1LðRD+1LþRG)e03245\n",
    ///     "+(-1LWRy-1LxRC+1LyRV+1LzRA-1LðRE+1LþRH)e01345\n",
    ///     "+(-1LWRz+1LxRB-1LyRA+1LzRV-1LðRF+1LþRI)e02145\n",
    ///     "+(+1LWRð+1LxRD+1LyRE+1LzRF+1LðRV+1LþRJ)e01235\n",
    ///     "+(-1LWRþ-1LxRG-1LyRH-1LzRI-1LðRJ+1LþRV)e01243\n",
    /// ));
    /// ```
    #[must_use]
    #[inline]
